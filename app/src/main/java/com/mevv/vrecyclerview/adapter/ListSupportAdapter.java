...
public abstract class ListSupportAdapter<T> extends VRecyclerAdapter<T> implements ListAdapter, SpinnerAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SupterVH holder = onCreate(convertView, parent, getItemViewType(position));
